...
sets = {
    ...
    ['Idle_Priority'] = {
        Head  = { 'Wivre Hairpin +1', 'Wivre Hairpin', 'Oracle\'s Cap', 'Curate\'s Hat',
             ...
             'Storm Turban', 'Trump Crown', 'Federation Headgear', 'Namru\'s Tiara',
             'Windurstian Headgear', 'Coven Hat', 'Enlil\'s Tiara', 'Ea\'s Tiara',
        ...
        Neck  = { 'Fenrir\'s Torque', 'Beak Necklace +1', 'Chi Necklace', 'Beak Necklace',
             ...
             'Hemp Gorget', 'Bird Whistle', 'Green Scarf' },
        ...
        Back  = { 'Storm Cape', 'Blue Cape +1', 'Blue Cape', 'Aurora Mantle +1',
             'Talisman Cape', 'Prism Cape', 'Enhancing Mantle', 'Aurora Mantle', 'Lucent Cape',
             ...
             'Cotton Cape +1' },
        Waist = { 'Hierarch Belt', 'Cleric\'s Belt', 'Desert Stone', 'Forest Stone',
             ...
             'Force Belt', 'Magic Belt', 'Penitent\'s Rope', 'Survival Belt' },
        Legs  = { 'Yigit Seraweels', 'Oracle\'s Braconi', 'Frog Trousers',
             ...
             'Anu\'s Brais', 'Zenith Slacks', 'Silk Slacks', 'Baron\'s Slops' },
    ...
    ['Precast_Priority'] = {
        ...
        Feet  = { 'Marduk\'s Crackows', 'Rostrum Pumps' },
    },
    -- Cure potency, healing magic skill and MND.
    ['Cure_Priority'] = {
        Head  = { 'Goliard Chapeau', 'Marduk\'s Tiara', 'Volunteer\'s Khud',
        ...
        Neck  = { 'Colossus\'s Torque', 'Phi Necklace', 'Jeweled Collar +1', 'Healing Torque',
             'Purgatory Collar', 'Enlightened Chain', 'Ajari Necklace', 'Stoneskin Torque',
        ...
        Back  = { 'Altruistic Cape', 'Prism Cape', 'Rainbow Cape', 'Peace Cape',
             ...
             'Mercenary Mantle', 'Talisman Cape', 'Mist Silk Cape' },
    ...
    ['Enfeebling_Priority'] = {
        ...
        Neck  = { 'Phi Necklace', 'Jeweled Collar +1', 'Morgana\'s Choker',
        ...
        Waist = { 'Ksi Sash', 'Al Zahbi Sash', 'Moon Sash', 'Water Belt', 'Bitter Corset',
             ...
             'Mercenary Captain\'s Belt', 'Shaman\'s Belt', 'Friar\'s Rope' },
    ...
    ['Divine_Priority'] = {
        Head  = { 'Marduk\'s Tiara', 'Elite Beret', 'Elite Beret +1', 'Aristocrat\'s Crown',
             ...
             'Garrison Sallet', 'Traveler\'s Hat', 'Eldritch Bone Hairpin' },
        Neck  = { 'Chi Necklace', 'Jeweled Collar +1', 'Morgana\'s Choker', 'Divine Torque',
        ...
        Hands = { 'Goliard Cuffs', 'Nashira Gages', 'Shadow Cuffs',
             ...
             'Zealot\'s Mitts' },
        Ring1 = { 'Epsilon Ring', 'Pi Ring', 'Insect Ring', 'Serene Ring', 'Vivian Ring',
        ...
        Ring2 = { 'Epsilon Ring', 'Pi Ring', 'Insect Ring', 'Serene Ring', 'Vivian Ring',
             'Grand Knight\'s Ring', 'Aquamarine Ring', 'Serenity Ring', 'Balrahn\'s Ring',
             'Kshama Ring No. 9', 'Vilma\'s Ring', 'Malflood Ring', 'Solace Ring', 'Tamas Ring',
             'Carect Ring', 'Lapis Lazuli Ring', 'Tranquility Ring', 'Saintly Ring' },
    ...
    ['TP_Priority'] = {
        Head  = { 'Nashira Turban', 'Walahra Turban', 'Pineal Hat', 'Qiqirn Hood',
             'Green Beret', 'Corsair\'s Tricorne', 'Super Ribbon', 'Vampire Mask',
             'Storm Zucchetto', 'Jester\'s Headband', 'Voyager Sallet', 'Spelunker\'s Hat',
             'Federation Headgear', 'Dandy Spectacles', 'Fancy Spectacles', 'Emperor Hairpin',
             'Empress Hairpin' },
        Neck  = { 'Aqua Gorget', 'Breeze Gorget', 'Diabolos\'s Torque', 'Sniper\'s Collar',
             'Grand Temple Knight\'s Collar', 'Chivalrous Chain', 'Spectacles',
             'Ashura Necklace', 'Storm Gorget', 'Auditory Torque', 'Peacock Amulet',
             'Peacock Charm', 'Tiger Stole', 'Fang Necklace', 'Spike Necklace',
             'Feather Collar +1' },
    ...
    ['Weapon_Priority'] = {
        Main  = { 'Mjollnir', 'Yagrush', 'Ultima\'s Left Arm', 'Ramuh\'s Mace',
             'Reserve Captain\'s Mace', 'Senior Gold Musketeer\'s Rod', 'Rune Rod',
             'Seawolf Cudgel', 'Sea Robber Cudgel', 'Darksteel Maul', 'Curse Wand',
             'Sloth Wand', 'Kingdom Mace', 'San d\'Orian Mace', 'Royal Squire\'s Mace',
             'Pixie Mace', 'Bastokan Hammer', 'Republic Hammer' },
        Sub   = { 'Tariqah', 'Tariqah +1', 'Viking Shield', 'Strike Shield', 'Wyvern Targe',
             'Genin Aspis', 'Healer\'s Shield', 'Wizard\'s Shield' },
    },
};
