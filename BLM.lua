...
sets = {
    ...
    ['Enfeebling_Priority'] = {
        ...
        Waist = { 'Ksi Sash', 'Al Zahbi Sash', 'Moon Sash', 'Arachne Obi', 'Bitter Corset',
             ...
             'Druid\'s Rope', 'Mantra Belt', 'Oracle\'s Belt', 'Sagacious Gold Obi',
    ...
    ['TP_Priority'] = {
        Head  = { 'Nashira Turban', 'Morrigan\'s Coronal', 'Pineal Hat', 'Opo-opo Crown',
    ...
    ['Weapon_Priority'] = {
        Main  = { 'Thanatos Baselard', 'Titan\'s Baselarde', 'Scepter',
             'Reserve Captain\'s Mace', 'Senior Gold Musketeer\'s Rod', 'Daylight Dagger',
             'Palladium Dagger', 'Garuda\'s Dagger', 'Curse Wand', 'Sloth Wand', 'Lust Dagger',
             'Triple Dagger', 'Kingdom Dagger', 'San d\'Orian Dagger', 'Royal Squire\'s Dagger',
