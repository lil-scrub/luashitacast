...
sets = {
    ...
    ['Pulling_NIN_Priority'] = {
        ...
        Head  = { 'Wivre Hairpin +1', 'Reikyo Hairpin', 'Wivre Hairpin', 'Faerie Hairpin',
             'Emperor Hairpin', 'Empress Hairpin', 'Gold Hairpin', 'Gold Hairpin +1',
             'Electrum Hairpin', 'Coral Hairpin', 'Merman\'s Hairpin', 'Reraise Hairpin',
             'Silver Hairpin', 'Silver Hairpin +1', 'Akinji Khud', 'Jaridah Khud',
             'Eld. Horn Hairpin', 'Horn Hairpin', 'Horn Hairpin +1', 'Brass Hairpin',
             'Brass Hairpin +1', 'Shell Hairpin', 'Shell Hairpin +1', 'Copper Hairpin',
             'Copper Hairpin +1', 'Bone Hairpin', 'Bone Hairpin +1', 'Io\'s helm',
             'Zenith Crown +1', 'Zenith Crown', 'Mahatma Hat', 'Errant Hat', 'Demon Helm +1',
             'Carapace Helm +1', 'Scorpion Helm +1', 'Dartorgor\'s Coif', 'Beak Helm +1',
             'Beak Helm', 'T.M. Hat +2', 'Dino Helm', 'Silk Hat +1',
             'Raptor Helm', 'Wool Cap +1', 'Carapace Mask +1', 'Wool Cap', 'Carapace Mask',
             'Namru\'s Tiara', 'Cuir Bandana +1', 'Cuir Bandana', 'Mage\'s Hat', 'Red Cap +1',
             'Strong Cap', 'Shade Tiara +1', 'Wool Hat +1', 'Shade Tiara', 'Great Headgear' },
        Neck  = { 'Star Necklace', 'Checkered Scarf', 'Wivre Gorget +1', 'Wivre Gorget',
             'Grand T.K. Collar', 'Torama Gorget', 'Kubira Beads', 'Coeurl Gorget',
             'Torque +1', 'Beak Necklace +1', 'Auditory Torque', 'Blue Gorget',
             'Brisingamen +1', 'Chivalrous Chain', 'Fortified Chain', 'Stoneskin Torque',
             'Torque', 'Beak Necklace', 'Intellect Torque', 'Carapace Gorget', 'Clay Amulet',
             'Stone Gorget', 'Memento Muffler', 'Wolf Gorget +1', 'Qiqirn Collar',
             'Brisingamen', 'Agile Gorget', 'Medieval Collar', 'Wolf Gorget', 'Holy Phial',
             'Hemp Gorget +1', 'Green Gorget', 'Van Pendant', 'Orochi Nodowa +1',
             'Merrow No. 17\'s Locket', 'Jagd Gorget', 'Mohbwa Scarf +1', 'Tiger Stole',
             'Hemp Gorget', 'Beetle Gorget', 'Black Neckerchief', 'Feather Collar +1',
             'Leather Gorget +1', 'Orochi Nodowa', 'Mohbwa Scarf', 'Dog Collar',
             'Feather Collar', 'Justice Badge', 'Leather Gorget', 'Regen Collar',
             'Sniper\'s Collar', 'Lieut. Gorget', 'Spirit Torque', 'Peacock Amulet',
             'Peacock Charm', 'Buburimu Gorget' },
        Ear1  = { 'Astral Earring', 'Intruder Earring', 'Bitter Earring', 'Cassie Earring',
             'Chaotic Earring', 'Haten Earring', 'Priest\'s Earring', 'Adroit Earring +1',
             'Cmn. Earring +1', 'Nimble Earring +1', 'Omn. Earring +1',
             'Robust Earring +1', 'Cel. Earring +1', 'Genius Earring +1',
             'Grace Earring +1', 'Mana Earring +1', 'Ser. Earring +1', 'Victory Earring +1',
             'Alc. Earring +1', 'Aura Earring +1', 'Deft Earring +1',
             'Puis. Earring +1', 'Solace Earring +1', 'Verve Earring +1',
             'Wisdom Earring +1', 'Mecurial Earring', 'Blc. Earring +1',
             'Crg. Earring +1', 'Energy Earring +1', 'Kldg. Earring +1',
             'Optical Earring', 'Reflex Earring +1', 'Stm. Earring +1', 'Novia Earring',
             'Delta Earring', 'Jupiter\'s Earring', 'Beta Earring', 'Brutal Earring',
             'Epsilon Earring', 'Eta Earring', 'Gamma Earring', 'Bat Earring',
             'Desamilion Earring', 'Fang Earring', 'Feyuh\'s Earring', 'Gayanj\'s Earring',
             'Melnina\'s Earring', 'Plantoid Earring', 'Geist Earring', 'Cunning Earring',
             'Dodge Earring', 'Mythril Earring', 'Mythril Earring +1', 'Reraise Earring',
             'Twinstone Earring', 'Beetle Earring' },
        Ear2  = { 'Astral Earring', 'Intruder Earring', 'Bitter Earring', 'Cassie Earring',
             'Chaotic Earring', 'Haten Earring', 'Priest\'s Earring', 'Adroit Earring +1',
             'Cmn. Earring +1', 'Nimble Earring +1', 'Omn. Earring +1',
             'Robust Earring +1', 'Cel. Earring +1', 'Genius Earring +1',
             'Grace Earring +1', 'Mana Earring +1', 'Ser. Earring +1', 'Victory Earring +1',
             ...
             'Dodge Earring', 'Mythril Earring', 'Mythril Earring +1', 'Reraise Earring',
             'Twinstone Earring', 'Beetle Earring' },
        Body  = { 'Akinji Peti', 'Jaridah Peti', 'Assault Jerkin', 'Kirin\'s Osode',
             'Vishnu\'s Vest', 'Narasimha\'s Vest', 'Dalmatica +1', 'Scp. Brstplate +1',
             'Minogame\'s Tunica', 'Commodore Frac', 'Bachelor Vest', 'Dalmatica',
             'Scp. Breastplate', 'Cpc. Brstplate +1', 'Cpc. Breastplate',
             'Tundra Jerkin', 'Beak Jerkin +1', 'Shaman\'s Cloak', 'Northern Jerkin',
             'Feral Jerkin', 'Beak Jerkin', 'R.K. Cloak +2',
             'R.K. Cloak +1', 'Flora Cotehardie', 'Dino Jerkin', 'Raptor Jerkin',
             'C.C. Cloak +2', 'C.C. Cloak +1', 'Wool Gambison +1',
             'Cpc. Harness +1', 'Cmb.Cst. Cloak', 'Wool Gambison',
             'Cuir Bouilli +1', 'Cuir Bouilli', 'Cloak +1', 'Cloak', 'Mana Cloak',
             'Mage\'s Robe', 'Strong Harness', 'Velvet Robe', 'Shade Harness +1',
             'Wool Robe +1', 'Shade Harness', 'Mage\'s Tunic', 'Wool Robe', 'Great Doublet',
        ...
        Hands = { 'Dune Bracers', 'Mahatma Cuffs', 'Errant Cuffs', 'Akinji Bazubands',
             'Jaridah Bazubands', 'Prt. Bangles', 'Zenith Mitts +1', 'Zenith Mitts',
             'Barb. Moufles', 'Marduk\'s Dastanas', 'Sheikh Gages', 'Sha\'ir Gages',
             'Cpc. Gauntlets +1', 'Cpc. Gauntlets', 'Feral Gloves',
             'Mst.Cst. Mitts', 'Dst. Mittens +1', 'Beak Gloves +1',
             'Battle Bracers +1', 'Tabin Bracers +1', 'Beak Gloves', 'Sand Gloves',
             'Dino Gloves', 'Silk Cuffs +1', 'Gold Bangles +1', 'Raptor Gloves',
             'Wool Bracers +1', 'Turtle Bangles +1', 'Cpc. Mittens +1', 'Wool Bracers',
             'Turtle Bangles', 'Carapace Mittens', 'Cuir Gloves +1', 'Rubious Mitts',
             'Cuir Gloves', 'Mage\'s Cuffs', 'Bracers +1', 'Sennight Bangles',
        ...
        Ring1 = { 'Serket Ring', 'Ether Ring', 'Astral Ring', 'Dark Ring', 'Electrum Ring',
             'Fasting Ring', 'Earth Ring', 'Fire Ring', 'Lightning Ring', 'Wind Ring',
             'Phalanx Ring', 'Unyielding Ring', 'Gobniu\'s Ring', 'Unfettered Ring',
             'Aegis Ring', 'Cerberus Ring +1', 'Adroit Ring +1', 'Cmn. Ring +1',
             'Hades Ring +1', 'Heavens Ring +1', 'Nimble Ring +1', 'Omn. Ring +1',
             'Gld.Msk. Ring', 'Tiger Ring', 'Allure Ring +1', 'Celerity Ring +1',
             'Genius Ring +1', 'Kshama Ring No. 4', 'Marid Ring +1', 'Ice Ring',
             ...
             'Kshama Ring No. 5', 'Kshama Ring No. 6', 'Bowyer Ring', 'Carect Ring',
             'Beetle Ring', 'Beetle Ring +1', 'Protean Ring', 'Variable Ring' },
        Ring2 = { 'Serket Ring', 'Ether Ring', 'Astral Ring', 'Dark Ring', 'Electrum Ring',
             ...
             'Kshama Ring No. 5', 'Kshama Ring No. 6', 'Bowyer Ring', 'Carect Ring',
             'Beetle Ring', 'Beetle Ring +1', 'Protean Ring', 'Variable Ring' },
        Back  = { 'Aslan Cape', 'Solitaire Cape', 'Bellicose Mantle', 'Shadow Mantle',
             'Mahatma Cape', 'Black Mantle +1', 'Feral Mantle', 'Errant Cape', 'Corse Cape',
             'Black Mantle', 'Lamia Mantle +1', 'Tiger Mantle', 'Beak Mantle +1',
             'Ryl. Army Mantle', 'Cvl. Mantle +1', 'Commander\'s Cape',
             'Boxer\'s Mantle', 'Lamia Mantle', 'Sand Mantle', 'Amemet Mantle +1',
             'Beak Mantle', 'Cvl. Mantle', 'Lightning Mantle', 'Dino Mantle',
             'Fed. Army Mantle', 'Jester\'s Cape +1', 'Volitional Mantle', 'Raptor Mantle',
             'Bat Cape', 'Aurora Mantle +1', 'Sentinel\'s Mantle', 'Jester\'s Cape',
             'Aurora Mantle', 'Red Cape +1', 'Ram Mantle', 'Ram Mantle +1', 'Wolf Mantle +1',
             'Dodge Cape', 'Tundra Mantle', 'Black Cape +1', 'White Cape +1',
        ...
        Waist = { 'Penitent\'s Rope', 'Quick Belt', 'Forest Rope', 'Star Sash', 'Anrin Obi',
             'Dorin Obi', 'Furin Obi', 'Hyorin Obi', 'Karin Obi', 'Korin Obi',
             'R.K. Belt +2', 'Earth Belt', 'Fire Belt', 'Ice Belt', 'Lightning Belt',
             'Water Belt', 'Wind Belt', 'Prism Obi', 'R.K. Belt +1',
             'Twinthread Obi +1', 'Ryl.Kgt. Belt', 'Brocade Obi +1', 'Swordbelt +1',
             'Corsette +1', 'Qiqirn Sash +1', 'Flagellant\'s Rope', 'Twinthread Obi',
             'Storm Belt', 'Brocade Obi', 'Swordbelt', 'Corsette', 'Gold Obi +1',
             'Silver Belt +1', 'Steppe Stone', 'Oracle\'s Belt', 'Deduct. Gold Obi',
             'Enthrall. Gold Obi', 'Gold Obi', 'Sagac. Gold Obi', 'Silver Belt',
             'Mohbwa Sash +1', 'Silver Obi +1', 'Magic Belt +1', 'Lizard Belt +1',
             'Shaman\'s Belt', 'Mohbwa Sash', 'Silver Obi', 'Magic Belt', 'Lizard Belt',
             'Friar\'s Rope', 'Heko Obi +1', 'Augmenting Belt', 'Leather Belt +1' },
        Legs  = { 'Akinji Salvars', 'Jaridah Salvars', 'Frog Trousers', 'Byakko\'s Haidate',
             'Zenith Slacks +1', 'Zenith Slacks', 'Mahatma Slops', 'Mrc. Subligar',
             'Errant Slops', 'Barb. Zerehs', 'Goliard Trews', 'Beak Trousers +1',
             'Feral Trousers', 'Beak Trousers', 'Femina Subligar', 'Vir Subligar',
             'Dst. Subligar +1', 'Tiger Trousers', 'Darksteel Subligar', 'Luna Subligar',
             'Battle Hose +1', 'Tabin Hose +1', 'Dino Trousers', 'Battle Hose', 'Ice Trousers',
             'Raptor Trousers', 'Silk Slops +1', 'T.M. Slops +2',
             'Wool Hose +1', 'Cpc. Subligar +1', 'Blaze Hose', 'Wool Hose',
        ...
        Feet  = { 'Rostrum Pumps', 'Mahatma Pigaches', 'Errant Pigaches', 'Akinji Nails',
             'Jaridah Nails', 'Suzaku\'s Sune-Ate', 'Zenith Pumps +1', 'Marduk\'s Crackows',
             'Zenith Pumps', 'Goliard Clogs', 'Rutter Sabatons', 'Dst. Leggings +1',
             'Bk. Ledelsens +1', 'Dst. Leggings', 'Feral Ledelsens', 'Battle Boots +1',
             ...
             'Wool Socks', 'Cpc. Leggings', 'C.C. Shoes +2',
             'Cuir Highboots +1', 'Powder Boots', 'C.C. Shoes +1', 'Cuir Highboots',
             'Ebony Sabots +1', 'Socks +1', 'Leggings +1', 'Rubious Pumps', 'Ebony Sabots',
             'Shade Leggings +1', 'Air Solea +1', 'Chs. Sabots +1', 'Shade Leggings',
             'Winged Boots +1', 'Great Gaiters', 'Btl. Leggings +1', 'Elder\'s Sandals',
             'Fine Ledelsens', 'Bone Leggings +1', 'Garrison Boots', 'Lizard Ledelsens',
             'Bone Leggings', 'Light Soleas', 'Holly Clogs +1', 'Brass Leggings +1' },
    },
    ...
    ['Pulling_WHM_Priority'] = {
        ...
        Ear2  = { 'Astral Earring', 'Intruder Earring', 'Bitter Earring', 'Cassie Earring',
             ...
             'Dodge Earring', 'Mythril Earring', 'Mythril Earring +1', 'Reraise Earring',
             'Twinstone Earring', 'Beetle Earring' },
        Body  = { 'Gaudy Harness', 'Akinji Peti', 'Jaridah Peti', 'Assault Jerkin', 'Kirin\'s Osode',
             'Vishnu\'s Vest', 'Narasimha\'s Vest', 'Dalmatica +1', 'Scp. Brstplate +1',
             'Minogame\'s Tunica', 'Commodore Frac', 'Bachelor Vest', 'Dalmatica',
             'Scp. Breastplate', 'Cpc. Brstplate +1', 'Cpc. Breastplate',
             'Tundra Jerkin', 'Beak Jerkin +1', 'Shaman\'s Cloak', 'Northern Jerkin',
