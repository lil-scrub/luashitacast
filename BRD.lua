...
sets = {
    ...
    ['Pulling_NIN_Priority'] = {
        ...
        Neck  = { 'Checkered Scarf', 'Benign Necklace', 'Sniper\'s Collar',
             ...
             'Grand T.K. Collar', 'Spectacles', 'Auditory Torque', 'Blue Gorget',
        ...
        Ear1  = { 'Novia Earring', 'Delta Earring', 'Refresh Earring', 'Chaotic Earring',
             'Haten Earring', 'Priest\'s Earring', 'Bitter Earring', 'Cel. Earring +1',
        ...
        Ring1 = { 'Dark Ring', 'Electrum Ring', 'Fasting Ring', 'Earth Ring', 'Fire Ring',
             ...
             'Cerberus Ring', 'Hard Leather Ring', 'Kshama Ring No. 4', 'Crossbowman Ring',
