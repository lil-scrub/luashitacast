...
sets = {
    ...
    ['Pulling_NIN_Priority'] = {
        ...
        Neck  = { 'Checkered Scarf', 'Benign Necklace', 'Sniper\'s Collar',
             'Lieutenant\'s Gorget', 'Orochi Nodowa', 'Orochi Nodowa +1', 'Qiqirn Collar',
             'Grand Temple Knight\'s Collar', 'Spectacles', 'Auditory Torque', 'Blue Gorget',
             'Carapace Gorget', 'Stone Gorget', 'Memento Muffler', 'Medieval Collar',
             'Holy Phial', 'Tiger Stole', 'Hemp Gorget', 'Van Pendant', 'Dog Collar',
             'Feather Collar' },
        Ear1  = { 'Novia Earring', 'Delta Earring', 'Refresh Earring', 'Chaotic Earring',
             'Haten Earring', 'Priest\'s Earring', 'Bitter Earring', 'Celerity Earring +1',
             'Genius Earring +1', 'Grace Earring +1', 'Alacrity Earring +1', 'Aura Earring +1',
             'Deft Earring +1', 'Mecurial Earring', 'Balance Earring +1', 'Courage Earring +1',
             'Energy Earring +1' },
        Ear2  = { 'Novia Earring', 'Delta Earring', 'Refresh Earring', 'Chaotic Earring',
             'Haten Earring', 'Priest\'s Earring', 'Bitter Earring', 'Celerity Earring +1',
             'Genius Earring +1', 'Grace Earring +1', 'Alacrity Earring +1', 'Aura Earring +1',
             'Deft Earring +1', 'Mecurial Earring', 'Balance Earring +1', 'Courage Earring +1',
             'Energy Earring +1' },
        ...
        Ring1 = { 'Dark Ring', 'Electrum Ring', 'Fasting Ring', 'Earth Ring', 'Fire Ring',
             'Lightning Ring', 'Tamas Ring', 'Peace Ring', 'Balrahn\'s Ring', 'Bellona\'s Ring',
             'Cerberus Ring', 'Hard Leather Ring', 'Kshama Ring No. 4', 'Crossbowman\'s Ring',
             'Aegis Ring', 'Alacrity Ring +1', 'Armored Ring', 'Balance Ring +1' },
        Ring2 = { 'Dark Ring', 'Electrum Ring', 'Fasting Ring', 'Earth Ring', 'Fire Ring',
             'Lightning Ring', 'Tamas Ring', 'Peace Ring', 'Balrahn\'s Ring', 'Bellona\'s Ring',
             'Cerberus Ring', 'Hard Leather Ring', 'Kshama Ring No. 4', 'Crossbowman\'s Ring',
             'Aegis Ring', 'Alacrity Ring +1', 'Armored Ring', 'Balance Ring +1' },
