...
sets = {
    ...
    -- Out of combat in caster mode: favours refresh and raw MP, ordered by
    -- how much MP each piece gives. The Earth staff goes on top.
    ['Idle_Priority'] = {
        Head  = { 'Curate\'s Hat', 'Electrum Hairpin', 'Rain Hat', 'Magi Hat', 'Silken Hat',
             'Storm Turban', 'Duelist\'s Chapeau', 'Duelist\'s Chapeau +1', 'Trump Crown',
             'Valkyrie\'s Mask', 'Republic Visor', 'Coven Hat', 'Bastokan Visor',
             'Republic Cap', 'Bastokan Cap', 'Macha\'s Crown', 'Bodb\'s Crown', 'Yigit Turban',
             'Scorpion Helm', 'Scorpion Helm +1', 'Blissful Chapeau' },
        Neck  = { 'Republican Gold Medal', 'Fenrir\'s Torque', 'Beak Necklace +1',
             'Chi Necklace', 'Beak Necklace', 'Merrow No. 17\'s Locket', 'Grandiose Chain',
             'Spirit Torque', 'Holy Phial', 'Jagd Gorget', 'Mohbwa Scarf +1',
             'Republican Iron Medal', 'Mohbwa Scarf', 'Republican Bronze Medal',
             'Morgana\'s Choker', 'Pachamac\'s Collar', 'Shield Pendant', 'Tiger Stole',
        ...
        Ear1  = { 'Celestial Earring', 'Magnetic Earring', 'Esquire\'s Earring',
             ...
             'Intruder Earring', 'Warlock\'s Earring', 'Mecurial Earring', 'Shield Earring',
             'Cassie Earring' },
        ...
        Hands = { 'Dune Bracers', 'Wood Gauntlets', 'Dragon Kote', 'Blood Finger Gauntlets',
             'Storm Gages', 'Crimson Finger Gauntlets', 'Magical Mitts', 'Magi Cuffs',
        ...
        Ring1 = { 'Variable Ring', 'Celestial Ring', 'Star Ring', 'Electrum Ring', 'Water Ring',
             'Fasting Ring', 'Mystic Ring +1', 'Aura Ring +1', 'Aura Ring', 'Energy Ring +1',
             'Black Ring', 'Dilation Ring', 'Bloodbead Ring', 'Sanation Ring', 'Peace Ring',
        ...
        Ring2 = { 'Variable Ring', 'Celestial Ring', 'Star Ring', 'Electrum Ring', 'Water Ring',
             ...
             'Balrahn\'s Ring', 'Gold Ring', 'Gold Ring +1', 'Mythril Ring', 'Mythril Ring +1',
             'Poisona Ring' },
        Back  = { 'Storm Cape', 'Empowering Mantle +1', 'Aurora Mantle +1', 'Talisman Cape',
             'Prism Cape', 'Empowering Mantle', 'Enhancing Mantle', 'Aurora Mantle',
             'Lucent Cape', 'Federal Army Mantle', 'Tundra Mantle', 'Invigorating Cape',
             'Maledictor\'s Shawl', 'Aries Mantle', 'High Breath Mantle', 'Wizard\'s Mantle',
             'Invisible Mantle', 'Wolf Mantle', 'Variable Cape', 'Breath Mantle', 'Cotton Cape' },
        Waist = { 'Lambda Sash', 'Hierarch Belt', 'Desert Stone', 'Grace Corset',
             ...
             'Volunteer\'s Belt', 'Magic Belt +1', 'Friar\'s Rope', 'Force Belt', 'Magic Belt',
        ...
        Feet  = { 'Ataractic Solea', 'Arborist Nails', 'Blood Greaves', 'Magi Pigaches',
