...
local sets = {
    ...
    ['Tp_Priority'] = {
        Head  = { 'Skadi\'s Visor', 'Brigand\'s Mask', 'Aurum Armet', 'Celata', 'Celata +1',
             ...
             'Luisant Salade', 'Valkyrie\'s Mask', 'Freya\'s Mask', 'Fed. Headgear',
             'Win. Headgear', 'Freyr\'s Mask', 'Emperor Hairpin', 'Shepherd\'s Bonnet',
             'Njord\'s Mask' },
        Neck  = { 'Dream Collar', 'Qiqirn Collar', 'Diabolos\'s Torque', 'Sniper\'s Collar',
             'Grand T.K. Collar', 'Chivalrous Chain', 'Ryl.Grd. Collar',
             'R.K. Army Collar', 'Storm Gorget', 'Peacock Amulet', 'Peacock Charm',
             'Ajase Beads', 'Tiger Stole', 'Fang Necklace', 'Spike Necklace' },
        Ear1  = { 'Brutal Earring', 'Ocl. Earring', 'Triton Earring', 'Merman\'s Earring',
        ...
        Ear2  = { 'Brutal Earring', 'Ocl. Earring', 'Triton Earring', 'Merman\'s Earring',
             'Minuet Earring', 'Platinum Earring', 'Assault Earring', 'Fang Earring',
             'Spike Earring', 'Gold Earring', 'Gold Earring +1', 'Tortoise Earring',
             'Mythril Earring +1', 'Reraise Earring', 'Beetle Earring', 'Bone Earring',
             'Bone Earring +1', 'Optical Earring' },
        Body  = { 'Askar Korazin', 'Io\'s Mail', 'Adaman Hauberk', 'Hauberk', 'Hauberk +1',
             'Byrnie', 'Haubergeon', 'Haubergeon +1', 'Ryl.Kgt. Chainmail',
             'Alumine Haubert', 'Luisant Haubert', 'Irn.Msk.Gmbsn. +1',
        ...
        Hands = { 'Skadi\'s Bazubands', 'Aurum Gauntlets', 'Dusk Gloves', 'Thick Mufflers',
             ...
             'Spiked Fng.Gnt.', 'Alumine Moufles', 'Luisant Moufles',
             'Ogygos\'s Brc.', 'Freya\'s Gloves', 'Federation Gloves',
             'Win. Gloves', 'Custom F Gloves', 'Custom M Gloves', 'Freyr\'s Gloves',
             'Bastokan Mittens', 'Kingdom Gloves', 'Njord\'s Gloves' },
        Ring1 = { 'Bellona\'s Ring', 'Mars\'s Ring', 'Cerberus Ring', 'Fire Ring',
             'Gnd.Kgt. Ring', 'Ptr.Prt. Ring', 'Tiger Ring',
             'Jalzahn\'s Ring', 'Ulthalam\'s Ring', 'Kshama Ring No. 8', 'Assailant\'s Ring',
             'Crossbowman Ring', 'Garnet Ring', 'Malflame Ring', 'Rajas Ring', 'Bowyer Ring',
        ...
        Ring2 = { 'Bellona\'s Ring', 'Mars\'s Ring', 'Cerberus Ring', 'Fire Ring',
             ...
             'Crossbowman Ring', 'Garnet Ring', 'Malflame Ring', 'Rajas Ring', 'Bowyer Ring',
             'Beetle Ring', 'Protean Ring', 'Fasting Ring', 'Mighty Ring', 'Courage Ring' },
        Back  = { 'Cerberus Mantle', 'Cerb. Mantle +1', 'Forager\'s Mantle', 'Psilos Mantle',
             'Amemet Mantle', 'Amemet Mantle +1', 'Ryl. Army Mantle', 'Rep. Army Mantle',
             'Jaguar Mantle' },
        Waist = { 'Ninurta\'s Sash', 'Buccaneer\'s Belt', 'Corsair\'s Belt', 'Sultan\'s Belt',
             'Fire Belt', 'Potent Belt', 'R.K. Belt +1', 'R.K. Belt +2',
        ...
        Legs  = { 'Skadi\'s Chausses', 'Adaman Breeches', 'Aurum Cuisses', 'Thick Breeches',
             'Thick Breeches +1', 'Feral Trousers', 'Ryl.Kgt. Breeches',
        ...
        Feet  = { 'Adaman Sollerets', 'Aurum Sabatons', 'Dusk Ledelsens', 'Thick Sollerets',
             ...
             'Federation Gaiters', 'Win. Gaiters', 'Savage Gaiters', 'Wonder Clomps',
    ...
    ['Charm_Priority'] = {
        ...
        Head  = { 'Mst. Helm +1', 'Bst. Helm +1', 'Monster Helm', 'Coral Cap',
        ...
        Neck  = { 'Temp. Torque', 'Oscar Scarf', 'Star Necklace', 'Stoneskin Torque',
        ...
        Body  = { 'Brave\'s Jacket', 'Khimaira Jacket', 'Stout Jacket', 'Byrnie', 'Byrnie +1',
             ...
             'Argent Coat', 'Ceremonial Dress', 'Freya\'s Jerkin', 'Fed. Doublet',
             'Win. Doublet', 'Freyr\'s Jerkin', 'Garrison Tunica' },
        Hands = { 'Monster Gloves', 'Mst. Gloves +1', 'Bst. Gloves +1', 'Marine F Gloves',
             'Marine M Gloves', 'Trainer\'s Wrist.' },
        ...
        Waist = { 'Monster Belt', 'Czar\'s Belt', 'Kaiser Belt', 'Koenigs Belt',
             'R.K. Belt +1', 'R.K. Belt +2', 'Desert Stone', 'Corsette',
             'Corsette +1' },
        Legs  = { 'Mst. Trousers +1', 'Monster Trousers', 'Bison Kecks', 'Coral Subligar',
             'Merman\'s Subligar', 'Luna Subligar', 'Dst. Codpiece', 'Ceremonial Hose',
             'Platino Hose', 'Custom Pants', 'Custom Slacks', 'Elder\'s Braguette' },
        Feet  = { 'Mst. Gaiters +1', 'Bst. Gaiters +1', 'Monster Gaiters', 'Marine F Boots',
